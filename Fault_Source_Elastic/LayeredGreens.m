function U=LayeredGreens(m,xloc,d,mu,lam,scaleN)

%U=LayeredGreens(m,xloc,d,mu,lam,scaleN)
...
[bignum,UR_0_2(:,j),US_0_2(:,j), ...
         ...
         UR_p2_2(:,j),US_p2_2(:,j),UT_p2_2(:,j)]=getbesselco(bignum,MM,Pd1,Pd2,Ph,sourceP4x4,...
   sourceP2x2,M2,g,t,k,j,lam,mu);
end
